<template>
    <div class="flex flex-col justify-center items-center p-10 lg:p-20 gap-8 lg:gap-10">
        ...
        <p class="body-text">Je suis William Brooks (ou tout simplement Will). J'ai 20 ans et je suis un étudiant en BUT MMI (Métiers du Multimédia et de l'Internet) dans le parcours du développement web. Depuis tout jeune, je suis très intéressé par l'informatique.</p>
