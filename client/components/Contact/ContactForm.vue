<template>
    <section id="contact-form" class="flex flex-col justify-center items-center gap-8 p-8 w-fit md:w-full">
                ...
                <form @submit.prevent="send" class="flex flex-col gap-4">
                    <div class="input-name-group flex flex-row gap-4 md:gap-2">
                        <div class="input-group relative mb-6 md:mb-4">
                            ...
                            />
                            <label for="firstname" class="absolute left-2 text-sm text-grey pointer-events-none transition-all px-1 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-grey peer-focus:top-1 peer-focus:text-xs peer-focus:text-secondary">
                                Prénom
                            </label>
                        ...
                        <div class="input-group relative mb-6 md:mb-4">
                            <input
                                ...
                                class="peer w-full pt-5 pb-2 px-2 text-base border-2 rounded-lg border-border-grey bg-transparent outline-none focus:border-secondary"
                            />
                            <label for="lastname" class="absolute left-2 text-sm text-grey pointer-events-none transition-all px-1 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-grey peer-focus:top-1 peer-focus:text-xs peer-focus:text-secondary">
                                Nom
                            </label>
                    ...
                    <div class="input-group relative mb-6 md:mb-4">
                        <input
                            ...
                            class="peer w-full pt-5 pb-2 px-2 text-base border-2 rounded-lg border-border-grey bg-transparent outline-none focus:border-secondary"
                        />
                        <label for="email" class="absolute left-2 text-sm text-grey pointer-events-none transition-all px-1 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-grey peer-focus:top-1 peer-focus:text-xs peer-focus:text-secondary">
                            Email
                        </label>
                    ...
                    <div class="input-group relative mb-6 md:mb-4">
                        <input
                            ...
                            class="peer w-full pt-5 pb-2 px-2 text-base border-2 rounded-lg border-border-grey bg-transparent outline-none focus:border-secondary"
                        />
                        <label for="subject" class="absolute left-2 text-sm text-grey pointer-events-none transition-all px-1 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-grey peer-focus:top-1 peer-focus:text-xs peer-focus:text-secondary">
                            Sujet
                        </label>
                    ...
                    <div class="input-group relative mb-6 md:mb-4">
                        <textarea
                            ...
                            class="peer w-full pt-5 pb-2 px-2 text-base border-2 rounded-lg border-border-grey bg-transparent outline-none focus:border-secondary"
                        ></textarea>
                        <label for="message" class="absolute left-2 text-sm text-grey pointer-events-none transition-all px-1 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-grey peer-focus:top-1 peer-focus:text-xs peer-focus:text-secondary">
                            Message
                        </label>
        ...
        <div v-if="showInvalidPopup" class="fixed top-8 left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-6 py-3 rounded shadow-lg z-[9999] text-lg font-semibold">
