...
class ProjectAdminController extends AbstractController
{
    ...
    public function upload(
        ...
        if (!$imageFile instanceof UploadedFile || !$imageFile->isValid()) {
            ...
            return $this->json(
                [
                    'error' => 'Une image JPG, JPEG ou PNG valide est obligatoire.',
        ...
        foreach ($technologyIds as $technologyId) {
            ...
            if ($technology === null) {
                return $this->json(
                    [
                        'error' => sprintf(
                            'La technologie #%d est introuvable.',
                            (int) $technologyId
                        ),
                    ],
                    Response::HTTP_BAD_REQUEST
    ...
    public function delete(
        ...
        if (!$project) {
            return $this->json(
                ['error' => 'Pas de projet avec cet ID.'],
    ...
    #[Route('/api/projects', name: 'api_project_index', methods: ['GET'])]
